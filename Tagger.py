...
async def help(event):
  ...
  await event.reply(helptext,
                    buttons=(
                      [Button.url('Beni Gruba Ekle➕', 'https://t.me/bozkurtaggerbot?startgroup=a')],
                      [Button.url('Support👨‍💻', 'https://t.me/muhabbetofkings')],
                      [Button.url('Resmi Kanal🔖', 'https://t.me/CyberTurkish')],
...
async def help(event):
  helptext = "**Çok özellikleri Etiket Botu Bulmaya Çalışan Grub Sahibleri @BOZKURTaggerBot Size Göre:\n\n📌 5-li etiket\n📌 Emoji etiket\n📌 Tekli Etiket\n📌 Yalnız Yöneticileri etiketleme\n📌\n\n Böyle Çok özellikli @LuciTaggerBot 'u grubunuza yönetici olarak ekleyip rahatlıkla üyelir , etiket ata bilirsiz **"
  await event.reply(helptext,
                    buttons=(
                      [Button.url('Botu Gruba Ekle➕', 'https://t.me/bozkurtaggerbot?startgroup=a')],
                    ),
                    link_preview=False
                   )
...
print(">> Bot aktif @bozkurtaggerbot <<")
